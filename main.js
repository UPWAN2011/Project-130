...
function draw(){
    ...
    song_kgf = Kgf_song.isPlaying();
    console.log(song_kgf);
    ...
    if(scoreleftWrist > 0.2){
        ...
        if(song_kgf == false){
            ...
            console.log("Song Name: Kgf Song");
            document.getElementById("song_id").innerHTML = "Song Name: Kgf Song";
        }
    }
